          ...
          <div class="shadow-lg">
            ...
            <div class="p-10">
              ...
              <div class="">
                ...
                <br />
                <span class="text-md font-medium text-gray-800"
                  ><a class="text-blue-700" href="<?php echo $row['drive']; ?>">  <?php echo $row['drive'] ; ?></a></span
                >
              </div>
    ...
    <script>
      $("#btn-approve").on("click", function (e) {
        ...
        Swal.fire({
          ...
          text: "NOTE: This student will be added for admission.",
          icon: "warning",
      ...
      $("#btn-decline").on("click", function (e) {
        ...
        Swal.fire({
          title: "Are you sure you?",
          text: "NOTE: This application will be declined. You won't be able to revert this.",
          icon: "warning",
          showCancelButton: true,
          confirmButtonColor: "#3085d6",
          cancelButtonColor: "#d33",
